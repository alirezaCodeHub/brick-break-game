...
public class Brick extends Sprite
{
    ...
    private void initBrick(int x, int y) throws IOException {
        ...
        //boolean for game.item drop bricks
        containsItem = false;
    ...
    private void loadImage(int index) throws IOException {
        if (index == 0) {
            var ii = new ImageIcon("src/game/images/newBreak.png");
            image = ii.getImage();
        } else if (index == 1) {
            var ii = new ImageIcon("src/game/images/brick_cracked_1.png");
            image = ii.getImage();
        } else if (index == 2) {
            var ii = new ImageIcon("src/game/images/brick_cracked_2.png");
            image = ii.getImage();
        } else if (index == 3) {
            var ii = new ImageIcon("src/game/images/cement.png");
            image = ii.getImage();
        } else if (index == 4){
            var ii = new ImageIcon("src/game/images/itemBrick.png");
            image = ii.getImage();
        }else {
            System.out.println("Bad index passed to game.Brick loadImage");
        }
